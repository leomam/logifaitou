...
public class SuppressionPanneauxEmplacementView extends Stage {
	...
	private Parent creerContenu() {
		...
		principale.getChildren().addAll(new Label("Que voulez vous supprimer ?"),boutonsC);
