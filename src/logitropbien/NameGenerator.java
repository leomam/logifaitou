...
public class NameGenerator extends Stage {
	...
	private String tabprenom [] = {"Achille","Adam","Victor","Agnès","Alexandre","Alexandra","Agathe","Arthur","Alexis","Fanny","Maya","Isabelle","Casiopée","Yakari","Chlodette","Sylvia","Sylvie","Brigitte","Anna","Anne","Jeremy","Eglantine","Clara","Maïwenn","Chlotilde","Jeremie","Thierry","Rita","Victoire","Alix","Benjamin","Jean-Baptiste","Jean-Luc","Jean-Paul","Paulin","Jessica","Enora","Raphaël","Raphaëlle","Lorent","Alice","Bernard","Alphonse","Brice","Keira","Cassandre","Cédric","Célestin","Colin","Bruno","Basile","Maxence","Aymeric","Antoine","Antonin","Alban","Adrien","Albert","Alex","Boris","Bilal","Axel","Hugo","Florent","Florian","Lucas","Josiane","Mathilde","Emma","Mathieu","Mélanie","Ugo","Ludovic","Loraine","Claude","Olivier","Pierre","Thomas","Clément","David","Ivan","Rachelle","Roger","Gérard","Lionel","Camille","Daniel","Henry","Hervé","José","Laura","Léon","Marie","Marion","Michel","Michelle","Noémie","Pascal","Pascale","Paul","Paule","Sandra","Théo","Titouan","Yann","Yoann"};
	private String tabnom [] = {"Alinaud","Lenormand","Hamilton","Romeshko","Diou","Chevalet","Pilo","Didou","Pujadas","Leroy","Roux","Leroux","Baffy","Biscart","Hachette","Bonnet","Béranger","Leblanc","Philippe","Balasco","Nidelle","Dargaud","Ferry","Dupre","Dupuis","Marion", "Henry","Maurel","Launay","Voisin"};
	...
	public void affichagetext(){
		...
		c = 0;
		rmois = r.nextInt(12);
		rjours = r.nextInt(tabnbjours[rmois]-1)+1;
